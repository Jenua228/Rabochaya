...
// node_modules/@ag-grid-enterprise/core/dist/package/main.esm.mjs
var MD5 = class {
  constructor() {
...
var _LicenseManager = class _LicenseManager2 {
  ...
  validateLicense() {
    const licenseDetails = this.getLicenseDetails(_LicenseManager2.licenseKey);
    ...
    if (licenseDetails.missing) {
      ...
      const gridReleaseDate = _LicenseManager2.getGridReleaseDate();
  ...
  getLicenseDetails(licenseKey) {
    const currentLicenseType = _LicenseManager2.chartsLicenseManager ? "BOTH" : "GRID";
...
var _AgPanel = class _AgPanel2 extends Component {
  ...
  postConstruct() {
    ...
    this.addManagedElementListeners(this.eTitleBar, {
      mousedown: (e) => {
        if (eGui.contains(e.relatedTarget) || eGui.contains(_getActiveDomElement(this.gos)) || this.eTitleBarButtons.contains(e.target)) {
          e.preventDefault();
          return;
        }
...
var TreeStrategy = class extends BeanStub {
  constructor() {
    super(...arguments);
...
//# sourceMappingURL=@ag-grid-enterprise_row-grouping.js.map
